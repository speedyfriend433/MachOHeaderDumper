...
// File: Views/DetailViews/ExportsView.swift

import SwiftUI
import MachO // For EXPORT constants

struct ExportsView: View {
    let exports: [ExportedSymbol] // Requires ExportedSymbol access
    ...
    func formatExportFlags(_ flags: UInt64) -> String {
        var parts: [String] = []
        // Ensure EXPORT constants are accessible (defined globally or imported)
